module.exports = app => {
  ...
  app.route("/tasks")
     ...
     * @apiSuccess {Boolean} tasks.updated_at Data de atualização
     * @apiSuccess {Boolean} tasks.created_at Data de cadastro
     ...
     *      "title": "Estudar",
     *      "done": false,
     *      "updated_at": "2017-01-01T15:45:51.778Z",
     *      "created_at": "2017-01-01T15:45:51.778Z",
     *      "user_id": 1
     *    }
     ...
     *      "title": "Estudar",
     *      "done": false,
     *      "updated_at": "2016-04-04T14:00:00.778Z",
     *      "created_at": "2016-04-04T14:00:00.778Z",
     *      "user_id": 1
     *    }
    ...
    app.route("/tasks/:id")
       ...
       * @apiSuccess {Boolean} updated_at Data de atualização
       * @apiSuccess {Boolean} created_at Data de cadastro
       ...
       * @apiParam {id} id Id da tarefa
       * @apiParam {String} title Título da tarefa
       * @apiParam {String} done Tarefa foi concluída
       * @apiParamExample {json} Entrada
       *    {
       *      "title": "Estudar",
       *      "done": true
